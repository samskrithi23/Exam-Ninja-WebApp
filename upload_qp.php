...
<head>
    ...
    <title>Upload Question Papers</title>
    <style>
        table {
...
<body>
    ...
    <form enctype="multipart/form-data" action="upload_qp_handler.php" method="post">
        ...
        <?php
            ...
            if ($result !== false && $result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><form action='delete_qp.php' method='post'>
