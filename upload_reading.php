...
<head>
    ...
    <title>Upload Reading notes</title>
    <style>
        table {
...
<body>
    <h1>Upload Reading Notes</h1>

    <!-- Form for uploading file -->
    <form enctype="multipart/form-data" action="upload_reading_handler.php" method="post">
    ...
    <table>
        ...
        <?php
            ...
            $sql = "SELECT id, file_name, file_path FROM reading";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><form action='delete_reading_notes.php' method='post'>
...
<script>
    function deleteFile(fileId) {
        ...
        if (confirmDelete) {
            ...
            form.method = "post";
            form.action = "delete_reading_notes.php";
