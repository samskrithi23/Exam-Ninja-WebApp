...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO speakingclips (video_name,video_link) VALUES ('$name','$video_link')";
...
if(isset($_GET['delete_id'])) {
    ...
    $delete_sql = "DELETE FROM speakingclips WHERE id = $delete_id";
