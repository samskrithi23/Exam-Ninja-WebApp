...
<head>
    ...
    <title>Upload Speaking Notes</title>
    <style>
        table {
...
<body>
    <h1>Upload Speaking Notes</h1>

    <!-- Form for uploading file -->
    <form enctype="multipart/form-data" action="upload_speaking_handler.php" method="post">
        ...
        <?php
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><form action='delete_speaking_notes.php' method='post'>
...
<script>
    function deleteFile(fileId) {
        ...
        if (confirmDelete) {
            ...
            form.method = "post";
            form.action = "delete_speaking_notes.php";
