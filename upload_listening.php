...
<head>
    ...
    <title>Upload Listening Notes</title>
    <style>
        table {
...
<body>
    <h1>Upload Listening Notes</h1>

    <!-- Form for uploading file -->
    <form enctype="multipart/form-data" action="upload_listening_handler.php" method="post">
    ...
    <table>
        ...
        <?php
            ...
            $sql = "SELECT id, file_name, file_path FROM listening";
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><form action='delete_listening_notes.php' method='post'>
...
<script>
    function deleteFile(fileId) {
        ...
        if (confirmDelete) {
            ...
            form.method = "post";
            form.action = "delete_listening_notes.php";
